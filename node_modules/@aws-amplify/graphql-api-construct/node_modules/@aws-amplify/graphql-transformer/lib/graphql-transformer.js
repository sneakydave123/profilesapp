...
const constructTransformerChain = (options) => {
    ...
    const allowGen1Patterns = (options === null || options === void 0 ? void 0 : options.allowGen1Patterns) === undefined ? true : options === null || options === void 0 ? void 0 : options.allowGen1Patterns;
    return [
        modelTransformer,
        ...
        ...(allowGen1Patterns ? [new graphql_predictions_transformer_1.PredictionsTransformer(options === null || options === void 0 ? void 0 : options.storageConfig)] : []),
        new graphql_index_transformer_1.PrimaryKeyTransformer(),
        indexTransformer,
        new graphql_relational_transformer_1.HasManyTransformer(),
        hasOneTransformer,
        ...(allowGen1Patterns ? [new graphql_relational_transformer_1.ManyToManyTransformer(modelTransformer, indexTransformer, hasOneTransformer, authTransformer)] : []),
        ...
        ...(allowGen1Patterns ? [new graphql_searchable_transformer_1.SearchableModelTransformer()] : []),
