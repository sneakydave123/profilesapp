...
import { AuthResources, AuthRoleName, ConstructFactory, ConstructFactoryGetInstanceProps, FunctionResources, ResourceAccessAcceptorFactory, ResourceProvider } from '@aws-amplify/plugin-types';
